...
export default function InventarioDistribuidoresPage() {
  ...
  useEffect(() => {
    // Temporary bypass - set default distribuidor user
    const defaultUser = {
      id: '3',
      ...
      <div className="bg-white shadow">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Inventario - Distribuidores</h1>
              <p className="text-gray-600">Precios mayoreo para distribuidores autorizados</p>
            </div>
                  ...
                  <tr key={product.id} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className="inline-flex px-2 py-1 text-xs font-semibold rounded-full bg-green-100 text-green-800">
                        {calculateSavings(product.priceRetail, product.priceWholesale)}% OFF
                      </span>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
