...
export const CarIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg
    ...
    className={className}
  >
    <path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9L18.4 9.6a2 2 0 0 0-1.6-1.4C16.2 8.1 14.2 8 12 8s-4.2.1-4.8.2c-.6.1-1.2.8-1.6 1.4L3.5 11.2C2.7 11.4 2 12.1 2 13v3c0 .6.4 1 1 1h2" />
